...
You can use [Nebula](https://github.com/xoxttxox/Nebula) to automate the generation of a distribution index.

The most up to date and accurate descriptions of the distribution spec can be viewed in [xox-distribution-types](https://github.com/xoxttxox/xox-distribution-types).
